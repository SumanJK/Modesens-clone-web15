    ...
    <>
      ...
      <div className={styles.title1}>MODESENS / SHOP / BEAUTY</div>
        <div className={styles.searchdiv}>
          ...
          <p>10,000+ ITEMS</p>
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Search_Icon.svg/1024px-Search_Icon.svg.png" width="25px"
            alt="search"
          />
        </div>
        <div className={styles.searchdiv}>
        ...
        <div className="first1">My Saved Searches
