      ...
      <Container>
                ...
                <MenuItem>WOMEN
                    <Dropdown>
                        <MenuInnerDiv>
                            ...
                            <MenuItem><span style={{color:"red"}}> SALE </span></MenuItem>
                ...
                <MenuItem>OFFER
                    <Dropdown>
                        <MenuInnerDiv>
                            ...
                            <MenuItem><span style={{color:"red"}}>WOMEN'S  SALE </span></MenuItem>
                            <MenuItem><span style={{color:"red"}}>MEN'S  SALE </span></MenuItem>
                        </MenuInnerDiv>
                    </Dropdown>
                </MenuItem>
            </MenuItemDiv>
        ...
        <Right>
            ...
            <Search onClick={handleFocus}>
                ...
                <Topbar >
                    <SearchContainer>
                        <InputSearch className="fontAwesome" ref={searchInput} type="text"  placeholder="&#xF002; Search by keyword or store URL"/>
                    </SearchContainer>
                </Topbar>
      </Container>
