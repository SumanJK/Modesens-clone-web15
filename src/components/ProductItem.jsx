...
const ProductItem = ({value}) => {
    ...
    // https://modesense-masai.herokuapp.com/beuties
  ...
  return (
    <div >
        ...
        {userDt.map((e)=>{
return(
        <Container onClick={()=>{handleUser(e)}}>
            <Link to ={`${e._id}`}>
          <HeartDIv>
          ...
          >
              <div style={{width: "80%", height: "220px", overflow: "hidden"}}>
          ...
          <TextDiv className="textDiv">
            ...
            <h6>${e.price}-${e.offprice}</h6>
            <span>{Math.floor(Math.random() * (20 - 5 + 1)) + 5}-store</span>
          </TextDiv>
          </Link>
        </Container>
)
