...
export const NavbarCouponSlider = () => {
    ...
    let coupon=[
        {
            ...
            title:"Download our Browser Extension and get three months of silver membership",
        ...
        {
            logo:"https://cdn.modesens.com/static/img/20180929logo.svg",
            title:"Download our Mobile App and get three months of silver membership",
  ...
  return (
    <SliderContainer >
            ...
            <ArrowDiv onClick={() => handleClick("left")} style={{position:"absolute", left:"0px"}}>
                <ChevronLeftIcon style={{ margin:"auto", color:"white",fontSize:"30px" }}/>
            </ArrowDiv>
            ...
            <ArrowDiv onClick={() => handleClick("right")} style={{position:"absolute", right:"0px"}}>
                <ChevronRightIcon style={{ margin:"auto" , color:"white" ,fontSize:"30px"}}/>
            </ArrowDiv>
