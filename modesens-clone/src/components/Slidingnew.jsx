    ...
    <>
      ...
      >
        ...
        <SwiperSlide>
            <div className="col">
        <div style={{position: "relative", height: "100%",width: "100%"}}>
                 <img style={{height: "100%", width: "100%"}} src="https://modesens.com/banner/11682/getimg/?img=%2Fbanner%2F20220427LengJing-modesens1140x400.jpg" alt="" />
            </div>
        ...
        <SwiperSlide>
            <div className="col">
        <div style={{position: "relative", height: "100%",width: "100%"}}>
           <img style={{height: "100%", width: "100%"}} src="https://modesens.com/banner/11726/getimg/?img=%2Fbanner%2F20220502-modesens-Mothersday-1140x400.jpg" alt="" />
            </div>
        ...
        <SwiperSlide>
            <div className="col">
        <div style={{position: "relative", height: "100%",width: "100%"}}>
           <img style={{height: "100%", width: "100%"}} src="https://modesens.com/banner/11648/getimg/?img=%2Fbanner%2F20220426-modesens-StatementSandal-1140x400-F.jpg" alt="" />
            </div>
        ...
        <div style={{position: "relative", height: "100%",width: "100%"}}>
           <img style={{height: "100%", width: "100%"}} src="https://modesens.com/banner/11585/getimg/?img=%2Fbanner%2F20220419-modesens-cutout-1140x400-F.jpg" alt="" />
            </div>
